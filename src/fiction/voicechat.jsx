  ...
  return (
    <Container maxWidth="md">
      ...
      >
        ...
        <Typography sx={{ mb: 1 }}>
          « HE HAS TERMINAL CANCER. UNFORTUNATELY THERE'S NOTHING MORE THAT YOU CAN DO. HIS ORGANS ARE SHUTTING DOWN. AND THERE'S NO WAY TO STOP IT. HE WILL BE GONE VERY SOON. I'M SORRY. »
        </Typography>
        <Typography sx={{ mb: 1 }}>
        ...
        <Typography sx={{ mb: 1 }}>
          In one ear and out the other. I think I heard Dad say that once before he got VoiceChat. I forgot that he didn't have the app yet when I was a kid. It was weird that he didn't use VoiceChat before. And then again at the end. He just made those bad breathing sounds and pushed the bedsheet up and down. I was glad that was over.
        </Typography>
        <Typography sx={{ mb: 1 }}>
          Mom was watching a movie upstairs when Dad died. She got the notification on her phone too. Her VoiceChat app was set to call mine a few minutes after she got it.
        </Typography>
        <Typography sx={{ mb: 1 }}>
        ...
        <Typography sx={{ mb: 1 }}>
          « OH HONEY. I AM TOO. HE'S IN A BETTER PLACE NOW. YOUR FATHER WAS SUCH A WONDERFUL LOVING MAN. » Mom took a big bite of something while her VoiceChat was talking. A sandwich? It made me hungry to see her eating. « SUCH A KIND AND GENTLE HUSBAND. AND FATHER. HE LOVED YOU WITH ALL HIS HEART. I DO TOO. » I thought I recognized one of the actors reflected in her glasses during a close-up shot. But I couldn't think of the name. And then the movie kept going.
        </Typography>
        <Typography sx={{ mb: 1 }}>
